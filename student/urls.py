...
from student.controllers.dashboard_controller import DashboardView,registerPage,find_result_view,PasswordChangeView,result
...
from student.controllers.student_controller import StudentListView,StudentCreateView,StudentUpdateView,StudentDeleteView
...
urlpatterns = [
    ...
    path('find-result/',find_result_view, name='find_result'),
    path('change-password/', PasswordChangeView.as_view(), name='change_password'),
    path('find-result/<int:pk>/result/',result, name='get_result'),
